...
import 'package:pz_erp_software/screens/add_employees.dart';
            ...
            Expanded(
              child: InkWell(
                  ...
                  child: _buildStatCard(
                      "Total Employees", "$totalEmployees", Icons.people)),
            ),
            const SizedBox(width: 16),
            Expanded(
                child: _buildStatCard(
                    "Active", "${employeeStats['active']}", Icons.check_circle,
                    color: Colors.green)),
            const SizedBox(width: 16),
            Expanded(
                child: _buildStatCard(
                    "Inactive", "${employeeStats['inactive']}", Icons.cancel,
                    color: Colors.red)),
          ],
        ),
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                EmployeeDetailPage(employeeId: employee.employeeId),
          ),
        );
      },
      child: Container(
        ...
        child: SingleChildScrollView(
          physics: const NeverScrollableScrollPhysics(), // avoids independent scrolling
          child: Column(
